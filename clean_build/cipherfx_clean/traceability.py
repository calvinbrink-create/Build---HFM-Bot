...
def requirement_bindings() -> Mapping[str, RequirementBinding]:
    ...
    bind("C006", ("cipherfx_clean.market", "cipherfx_clean.store", "cipherfx_clean.tick_ingest"), ("DATA",))
    bind("C007", ("cipherfx_clean.market", "cipherfx_clean.data_quality", "cipherfx_clean.observation", "cipherfx_clean.tick_ingest"), ("DATA", "VALIDATION"))
