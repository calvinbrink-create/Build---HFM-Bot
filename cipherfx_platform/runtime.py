...
class ModularTradingRuntime:
    """Authoritative orchestration of the independent asset engines."""
    ...
    def __init__(self, settings: ServiceSettings):
        ...
        self.heartbeat_path = Path(os.getenv(
            "MT5_HEARTBEAT_FILE",
    ...
    def run_once(self) -> dict[str, int]:
        summary = {"symbols": 0, "proposals": 0, "filled": 0, "rejected": 0}
        for canonical in self.config.all_symbols():
            ...
            try:
                ...
                summary["filled" if result.status in {"FILLED", "DRY_RUN"} else "rejected"] += 1
